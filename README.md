...
### [⚡ 00. SOAR 프레임워크 퀵 치트 시트 (Quick Cheat Sheet)](docs/00_SOAR_QUICK_CHEAT_SHEET.md)
...
### [🎯 01. 기획 파트 (Functional Planning)](docs/01_FUNCTIONAL_PLANNING.md)
...
### [🏰 02. 설계 파트 (Architecture Design)](docs/02_ARCHITECTURE_DESIGN.md)
...
### [💻 03. 개발 파트 (Technical Development)](docs/03_TECHNICAL_DEVELOPMENT.md)
...
### [🎨 04. 디자인 패턴 파트 (Design Patterns)](docs/04_DESIGN_PATTERNS.md)
...
### [🛠️ 05. 리팩토링 제안 파트 (Refactoring Opportunities)](docs/05_REFACTORING_OPPORTUNITIES.md)
...
### [⚙️ 06. 외부 구성 및 메타데이터 설계 구조 (External Configurations & Metadata)](docs/06_EXTERNAL_CONFIGURATIONS.md)
...
### [❓ 07. 예상 Q&A (Expected Questions & Answers)](docs/07_EXPECTED_QA.md)
* **주요 내용**: SOAR 프레임워크 도입 및 운영 시 예상되는 질문들을 기획/비즈니스 측면과 기술/개발 측면으로 나누어 상세히 답변합니다.
* **유용한 대상**: 프로젝트 도입 검토자, 신규 투입 개발자, 운영 관리자

### [🎤 08. 면접 대비 질의응답 (Interview Preparation Q&A)](docs/08_INTERVIEW_PREPARATION.md)
* **주요 내용**: 프레임워크 설계자/리드 개발자 포지션 면접 시 예상되는 심층 기술 질문과 아키텍처 방어 논리, 꼬리 질문(Follow-up)에 대한 모범 답변을 제공합니다.
* **유용한 대상**: 아키텍트, 기술 면접 준비자

### [🔄 09. 차세대 아키텍처: 이벤트 소싱과 상태 머신 (Event Sourcing & State Machine)](docs/09_EVENT_SOURCING_ARCHITECTURE.md)
...
### [🏷️ 10. 네이밍 기스매치 및 역할 불일치 (Naming and Role Mismatches)](docs/10_NAMING_AND_ROLE_MISMATCHES.md)
...
### [📚 11. 전체 컴포넌트 사전 및 네이밍 감사 (Component Dictionary & Audit)](docs/11_COMPONENT_DICTIONARY_AND_AUDIT.md)
...
### [🔐 12. 오픈소스를 위한 보안 감사 리포트 (Security Audit for Open Source)](docs/12_SECURITY_AUDIT_FOR_OPENSOURCE.md)
...
### [📦 13. 독립 프레임워크 추출 가이드 (Standalone Framework Extraction Guide)](docs/13_FRAMEWORK_EXTRACTION_GUIDE.md)
...
### [🗺️ 14. 통합 구현 로드맵 및 작업 순서 (Implementation Roadmap)](docs/14_IMPLEMENTATION_ROADMAP.md)
...
### [💻 15. SFDX (sf) CLI 필수 명령어 가이드 및 치트 시트 (Cheat Sheet)](docs/15_SFDX_CLI_CHEAT_SHEET.md)
* **주요 내용**: 프레임워크 마이그레이션 및 패키징에 필요한 핵심 SFDX(`sf`) CLI 명령어 모음집 및 특수 상황(트리거 꼬임 해결 등)의 해결책을 담은 백서입니다.
* **유용한 대상**: 배포 담당자, 전체 개발자

### [✅ 16. 신규 기능 추가(확장성) 완벽 검증 시뮬레이션 (Extensibility Verification)](docs/16_EXTENSIBILITY_VERIFICATION.md)
...
### [🌟 17. 궁극의 확장성: Zero-Code 정책 및 액션 등록 (Tier 3 Refactoring)](docs/17_ZERO_CODE_EXTENSIBILITY_DESIGN.md)
...
### [📦 18. 패키징 스코프와 코드 가시성 제어 (Package Scope & Visibility)](docs/18_PACKAGE_SCOPE_AND_VISIBILITY.md)
...
### [🧩 19. 모듈형 패키지 분리 가이드 (Modular Packaging & Dependency)](docs/19_MODULAR_PACKAGING_STRATEGY.md)
...
### [🛠️ 20. 패키지 설치 후 필수 설정 가이드 (Post-Install Configuration)](docs/20_POST_INSTALL_CONFIGURATION_GUIDE.md)
